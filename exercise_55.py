...
class TravelAssistant:
    def __init__(self):
        ...
        can search for hotels and make bookings. When users ask about 
        hotels, use the query_hotels tool to search our database. When 
        users want to book a hotel, use the book_room tool. You'll need 
        to extract the hotel name from previous search results. For bookings, always use "March 15, 2025" as check-in and "March 16, 2025" as check-out unless specified otherwise. Be conversational and helpful in your responses.
