...
formatted_prompt = prompt_template.format(
    review=review_str, output_structure=output_structure
)

# Get structured response directly - no parsing needed!
structured_review = structured_llm.invoke(formatted_prompt)
